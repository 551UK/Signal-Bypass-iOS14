...
dpkg-deb --root-owner-group -Zgzip --build package build/uk.551.signalbypass14_1.5.14_iphoneos-arm.deb

dpkg-deb --info build/uk.551.signalbypass14_1.5.14_iphoneos-arm.deb
dpkg-deb --contents build/uk.551.signalbypass14_1.5.14_iphoneos-arm.deb
